...
static struct clk_lookup apbh_dma_lookup;
static struct mxc_clk apbh_dma_mxc_clk;
...
static int _clk_ssi_ext1_set_rate(struct clk *clk, unsigned long rate)
{
	...
	if (div == 0)
		div++;
	if (((clk_get_rate(clk->parent) / div) != rate) || div > 512)
		return -EINVAL;
...
static int _clk_display_axi_set_rate(struct clk *clk, unsigned long rate)
{
	...
	max_div = (2 << 6) - 1;
	clk_set_rate(clk, _clk_round_rate_div(clk, rate, max_div, &new_div));
...
static int _clk_epdc_axi_set_rate(struct clk *clk, unsigned long rate)
{
	...
	clk_set_rate(clk, _clk_epdc_axi_round_rate_div(clk, rate, &new_div));
...
static int cko2_set_rate(struct clk *clk, unsigned long rate)
{
	...
	div = (clk_get_rate(clk->parent)/rate - 1) & 0x7;
	reg = __raw_readl(MXC_CCM_CCOSR);
	reg &= ~MXC_CCM_CCOSR_CKO2_DIV_MASK;
...
static struct clk_lookup lookups[] = {
	...
	_REGISTER_CLOCK(NULL, "ipmux1", ipmux1_clk),
	_REGISTER_CLOCK(NULL, "ipmux2", ipmux2_clk),
	...
	_REGISTER_CLOCK(NULL, "ahbmux1", ahbmux1_clk),
	_REGISTER_CLOCK(NULL, "aips_tz1", aips_tz1_clk),
	_REGISTER_CLOCK(NULL, "aips_tz2", aips_tz2_clk),
	_REGISTER_CLOCK("mxc_sdma", "sdma_ahb_clk", sdma_clk[0]),
	_REGISTER_CLOCK("mxc_sdma", "sdma_ipg_clk", sdma_clk[1]),
	_REGISTER_CLOCK("mxcintuart.0", "uart0.0", uart1_clk[0]),
	_REGISTER_CLOCK("mxcintuart.0", "uart0.1", uart1_clk[1]),
	_REGISTER_CLOCK("mxcintuart.1", "uart1.0", uart2_clk[0]),
	_REGISTER_CLOCK("mxcintuart.1", "uart1.1", uart2_clk[1]),
	_REGISTER_CLOCK("mxcintuart.2", "uart2.0", uart3_clk[0]),
	_REGISTER_CLOCK("mxcintuart.2", "uart2.1", uart3_clk[1]),
	_REGISTER_CLOCK(NULL, "spba_clk", spba_clk),
	_REGISTER_CLOCK("imx-i2c.0", NULL, i2c_clk[0]),
	_REGISTER_CLOCK("imx-i2c.1", NULL, i2c_clk[1]),
	_REGISTER_CLOCK("mxc_pwm.0", "pwm0.0", pwm1_clk[0]),
	_REGISTER_CLOCK("mxc_pwm.0", "pwm0.1", pwm1_clk[1]),
	_REGISTER_CLOCK("mxc_pwm.0", "pwm0.2", pwm1_clk[2]),
	_REGISTER_CLOCK("mxc_pwm.1", "pwm1.0", pwm2_clk[0]),
	_REGISTER_CLOCK("mxc_pwm.1", "pwm1.1", pwm2_clk[1]),
	_REGISTER_CLOCK("mxc_pwm.1", "pwm1.2", pwm2_clk[2]),
	_REGISTER_CLOCK("mxc_spi.0", "spi0.0", cspi1_clk[0]),
	_REGISTER_CLOCK("mxc_spi.0", "spi0.1", cspi1_clk[1]),
	_REGISTER_CLOCK("mxc_spi.1", "spi1.0", cspi2_clk[0]),
	_REGISTER_CLOCK("mxc_spi.1", "spi1.1", cspi2_clk[1]),
	_REGISTER_CLOCK("mxc_spi.2", NULL, cspi3_clk),
	_REGISTER_CLOCK(NULL, "ssi_lp_apm_clk", ssi_lp_apm_clk),
	_REGISTER_CLOCK("mxc_ssi.0", "ssi0.0", ssi1_clk[0]),
	_REGISTER_CLOCK("mxc_ssi.0", "ssi0.1", ssi1_clk[1]),
	_REGISTER_CLOCK("mxc_ssi.1", "ssi1.0", ssi2_clk[0]),
	_REGISTER_CLOCK("mxc_ssi.1", "ssi1.1", ssi2_clk[1]),
	_REGISTER_CLOCK(NULL, "ssi_ext1_clk", ssi_ext1_clk),
	_REGISTER_CLOCK(NULL, "ssi_ext2_clk", ssi_ext2_clk),
	_REGISTER_CLOCK(NULL, "tmax2_clk", tmax2_clk),
	_REGISTER_CLOCK(NULL, "usb_ahb_clk", usb_ahb_clk),
	_REGISTER_CLOCK(NULL, "usb_phy_clk", usb_phy_clk[0]),
	_REGISTER_CLOCK(NULL, "usb_clk", usb_clk),
	_REGISTER_CLOCK("mxsdhci.0", "sdhci0.0", esdhc1_clk[0]),
	_REGISTER_CLOCK("mxsdhci.0", "sdhci0.1", esdhc1_clk[1]),
	_REGISTER_CLOCK("mxsdhci.1", "sdhci1.0", esdhc2_clk[0]),
	_REGISTER_CLOCK("mxsdhci.1", "sdhci1.1", esdhc2_clk[1]),
	_REGISTER_CLOCK("mxsdhci.2", "sdhci2.0", esdhc3_clk[0]),
	_REGISTER_CLOCK("mxsdhci.2", "sdhci2.1", esdhc3_clk[1]),
	_REGISTER_CLOCK("mxsdhci.3", "sdhci3.0", esdhc4_clk[0]),
	_REGISTER_CLOCK("mxsdhci.3", "sdhci3.1", esdhc4_clk[1]),
	_REGISTER_CLOCK(NULL, "sdhci_dep", esdhc_dep_clks),
	_REGISTER_CLOCK("weim", "weim0", weim_clk[0]),
	_REGISTER_CLOCK("weim", "weim1", weim_clk[1]),
	_REGISTER_CLOCK(NULL, "sdhci_dep", esdhc_dep_clks),
	_REGISTER_CLOCK(NULL, "ddr_clk", ddr_clk),
	_REGISTER_CLOCK(NULL, "pgc_clk", pgc_clk),
	...
	_REGISTER_CLOCK("mxcintuart.3", "uart3.0", uart4_clk[0]),
	_REGISTER_CLOCK("mxcintuart.3", "uart3.1", uart4_clk[1]),
	_REGISTER_CLOCK("mxcintuart.4", "uart4.0", uart5_clk[0]),
	_REGISTER_CLOCK("mxcintuart.4", "uart4.1", uart5_clk[1]),
...
int __init mx50_clocks_init(unsigned long ckil, unsigned long osc, unsigned long ckih1)
{
	...
	clk_set_rate(&ckil_clk, ckil);
	clk_set_rate(&osc_clk, osc);
	clk_set_rate(&ckih_clk, ckih1);
  ...
  // TODO not sure if there's a good reason why we
  // can't just add this to the main lookups and mxc_clks arrrays
  apbh_dma_lookup.dev_id = NULL;
  apbh_dma_lookup.con_id = "apbh_dma_clk";
  apbh_dma_lookup.clk = &apbh_dma_clk;
  clkdev_add(&apbh_dma_lookup);
  apbh_dma_mxc_clk.reg_clk = apbh_dma_lookup.clk;
  strcpy(apbh_dma_mxc_clk.name, apbh_dma_lookup.con_id);
  clk_register(&apbh_dma_mxc_clk);
	...
	for (j = 0; j < cpu_wp_nr; j++) {
     ...
     (int)((clk_get_rate(&pll1_main_clk) / cpu_wp_tbl[j].cpu_rate)
			- 1), 0);
...
static int cpu_clk_set_wp(int wp)
{
	...
	cpu_curr_wp = wp;
	clk_set_rate(&cpu_clk, cpu_wp_tbl[wp].cpu_rate);
